  ...
  <div class="checkout-shell">
    ...
    <template v-if="step === 'cart'">
      ...
      <div v-else class="empty-state" style="padding:48px 20px">
        <div class="empty-state-icon">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" style="width:32px;height:32px;color:var(--neutral-300)"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/></svg>
        </div>
    ...
    <template v-if="step === 'payment'">
      <div class="checkout-header">
        <button class="btn btn-sm btn-ghost" @click="store.checkoutStep='cart'" style="margin-right:8px">
